...
export const Tabs = ( {
	...
	return (
		<TabsContext.Provider value={ contextValue }>
			<div
				className={ `updatronix-tabs updatronix-tabs--${ orientation }` }
			>
				{ children }
			</div>
...
export const Tab = ( {
	...
	return (
		<button
			ref={ tabRef }
			className={ `updatronix-tabs__tab ${
				isSelected ? 'updatronix-tabs__tab--is-active' : ''
			} ${
				icon ? 'updatronix-tabs__tab--has-icon' : ''
			} ${ className }`.trim() }
			role="tab"
