...
function updatronix_render_delay_context_admin_notice(): void {
	...
	echo '<div style="display: inline-flex; flex-direction: column; width: 920px; max-width: 100%; text-align: left; justify-content: flex-start; align-items: flex-start;" class="notice notice-info updatronix-delay-context-notice components-notice is-info"><p>';
	echo esc_html(
		sprintf(
